...
echo "       Run Windowed.sh       — runs in a small window (for testing)"
echo "       Run Fullscreen.sh     — fullscreen on the primary display"
echo "       Run Projector.sh      — fullscreen on display 1 (projector)"
echo ""
